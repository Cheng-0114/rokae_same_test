...
其它机型（SR3、CR7、Pro3、AR5L、**AR5L08** 等）将 robot_type 替换为对应后缀即可。
"""
import os
import yaml
...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument(
            "robot_type",
            default_value="CR7",
            description="机型后缀，须与 rokae_hardware/config/xMate{robot_type}_controllers.yaml 一致（如 CR35、SR5、AR5L08）。",
        ),

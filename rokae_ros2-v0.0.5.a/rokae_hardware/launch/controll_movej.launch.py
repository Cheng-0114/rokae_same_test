...
def _resolve_model_base_name(robot_type):
    ...
    return name_map.get(robot_type, f"xMate{robot_type}")
...
def _resolve_entity_name(robot_type):
    ...
    return entity_map.get(robot_type, f"xMate{robot_type}")
...
def launch_setup(context, *args, **kwargs):
    ...
    if enable_gui:
        joint_state_publisher_gui = Node(
            ...
            parameters=[
                {"robot_description": robot_desc_xml},
                # Wall clock for user slider input; do not gate on /clock.
                {"use_sim_time": False},
            ],
        ...
        gui_control_node = Node(
            ...
            parameters=[
                ...
                # Continuous slider updates: topic is more reliable than preempting actions.

...
def generate_launch_description():
    ...
    enable_movej_arg = DeclareLaunchArgument(
        "enable_movej",
        default_value="false",
        description=(
            "If true, start demo movej node (auto motion on launch). "
            "Default false — use RViz Plan & Execute manually."
        ),
    )
    default_velocity_scaling_arg = DeclareLaunchArgument(
        "default_velocity_scaling_factor",
        default_value="0.1",
        description="MoveIt default velocity scale (0~1); RViz slider applies on top at plan time.",
    )
    default_acceleration_scaling_arg = DeclareLaunchArgument(
    ...
    default_velocity_scaling = LaunchConfiguration("default_velocity_scaling_factor")
    default_acceleration_scaling = LaunchConfiguration(
        "default_acceleration_scaling_factor"
    )
    ...
    controller_yaml = PathJoinSubstitution([
        ...
        PythonExpression([
            ...
            "('", robot_type, "' in ['CR7','CR12','CR18','CR20','ER3','ER7','AR5L','AR5R','AR5R08','AR5L08','AR3R','AR3L','Pro3','Pro7','SR3','SR4','SR5','XB7s','XB7h','NB25s','NB25h','NB12s','NB12h','EB4','NB4','XB4s','XB4h'])) "
    ...
    return LaunchDescription([
        ...
        enable_movej_arg,
        default_velocity_scaling_arg,
        default_acceleration_scaling_arg,
